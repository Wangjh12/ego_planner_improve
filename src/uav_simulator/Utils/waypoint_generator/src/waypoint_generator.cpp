...
//从rviz中设置的点会通过goal这个话题发送，sub2订阅这个话题并把内容存到waypoints中，然后以waypoints的话题发布出去，接着在ego_planner_fsm中订阅这个话题，获取到目标点让后进行规划处理
//注意话题名在roslaunch中做了重映射，注意区分，订阅和发布的重订阅方向不同
